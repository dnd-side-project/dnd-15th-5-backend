...
public class GooglePlaceTextSearchRateLimiter {

    private static final String RATE_LIMIT_KEY_PREFIX =
            "chapchap:place:google-places:text-search:";
    private static final int MONTHLY_LIMIT = 4_500;
    ...
    public void acquirePermit() {
        ...
        if (count == LIMIT_EXCEEDED) {
            throw new BusinessException(PlaceErrorCode.TEXT_SEARCH_REQUEST_LIMIT_EXCEEDED);
        }
